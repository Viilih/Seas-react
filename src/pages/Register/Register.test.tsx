...
describe("Register", () => {
  ...
  test("Testar se ao digitar um cep inválido, os valores serem undefined", async () => {
    ...
    expect(data.erro).toEqual(true);
    expect(data.logradouro).toEqual(undefined);
    expect(data.bairro).toEqual(undefined);
    expect(data.localidade).toEqual(undefined);
    expect(data.uf).toEqual(undefined);
  });
